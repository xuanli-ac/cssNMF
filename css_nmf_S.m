function [S,objhistory,obj_diff]= css_nmf_S(V, H, maxiter,tolvalue,showflag)
...
% rdim: reduced rank
% 3. maxiter: the maximum times of iterations
% 4. tolvalue: iteration ends if obj_diffnew<tolvalue.
% 5. showflag: 1 or 0. 1: show figures of convergence
...
while (iter<maxiter) && (objdiffnew>=tolvalue),
    ...
    % Calculate obj value
    newobj=cal_objval(V,S,H);
    
    %disp(['update S'])  ;
    
    objdiffnew=abs(objhistory(end)-newobj);
